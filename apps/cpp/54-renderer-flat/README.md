...
## Concept
The **exact same renderer as [53-renderer-hpp](../53-renderer-hpp/)** — every
...
```sh
make run app=54-renderer-flat ARGS="assets/tinyrenderer/african_head/african_head.obj normal assets/tinyrenderer/african_head/african_head_diffuse.ppm assets/tinyrenderer/african_head/african_head_nm_tangent.ppm"
```
