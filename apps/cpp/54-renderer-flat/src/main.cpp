// 54-renderer-flat — the ENTIRE tinyrenderer pipeline in one translation unit.
//
// This is a mechanical flatten of the multi-file 53-renderer-hpp: identical
// renderer, single file. See apps/cpp/54-renderer-flat/README.md for the
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        std::cerr << "54-renderer-flat: " << e.what() << '\n';
        return 1;
    }
