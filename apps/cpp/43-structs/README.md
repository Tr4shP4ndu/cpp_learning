...
and everything a `class` has (lesson 45). Convention: use `struct` for plain
...
- Copying a struct copies every field (value semantics, lesson 37).

## Build & run
```sh
make run app=43-structs      # C++
