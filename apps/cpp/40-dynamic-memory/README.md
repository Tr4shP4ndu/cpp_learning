...
## Minimal example
See `src/main.cpp`. The C version of this lesson lives in [`apps/c/41-dynamic-memory`](../../c/41-dynamic-memory/) (run it with `make run-c-app-30-dynamic-memory`).
...
make run-c-app-30-dynamic-memory    # C
```
