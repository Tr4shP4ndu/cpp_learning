...
parameters. Where a plain template's requirements are implicit (lesson 46), a
...
## Build & run
```sh
make run app=47-concepts
make build app=47-concepts STD=c++17   # concepts don't exist yet — fails
```
