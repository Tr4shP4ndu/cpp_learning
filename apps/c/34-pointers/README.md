...
The C version of [`apps/cpp/34-pointers`](../../cpp/34-pointers/). Pointers are
...
(lesson 37) so you rarely manage raw owning pointers. See the
[C++ version](../../cpp/34-pointers/).

## Build & run
```sh
make run-c app=34-pointers
```
