...
## Concept
The **same renderer as [53-renderer-hpp](../../cpp/53-renderer-hpp/)**, ported to
...
## Layout: `.h` vs no-`.h`
Just like C++'s header/source split (lesson 30), but with C's tools:
...
```sh
make run-c app=55-renderer-h ARGS="assets/tinyrenderer/african_head/african_head.obj normal assets/tinyrenderer/african_head/african_head_diffuse.ppm assets/tinyrenderer/african_head/african_head_nm_tangent.ppm"
```
