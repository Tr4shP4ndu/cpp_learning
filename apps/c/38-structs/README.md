...
The C version of [`apps/cpp/38-structs`](../../cpp/38-structs/). This is where C
...
`class` for data + behavior. See the [C++ version](../../cpp/38-structs/) and,
for behavior, lesson 40 (classes).

## Build & run
```sh
make run-c app=38-structs
```
