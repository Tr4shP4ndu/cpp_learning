...
## Concept
The **same renderer as [55-renderer-h](../55-renderer-h/)** — the whole C
pipeline — collapsed into **one `main.c`**. Same code, one file. It is to 55
what [54-renderer-flat](../../cpp/54-renderer-flat/) is to 53: the flatten is the
lesson.
...
```sh
make run-c app=56-renderer-flat ARGS="assets/tinyrenderer/diablo3_pose/diablo3_pose.obj phong assets/tinyrenderer/diablo3_pose/diablo3_pose_diffuse.ppm"
```
