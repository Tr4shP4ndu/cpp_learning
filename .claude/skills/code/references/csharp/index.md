...
|-------|-----------|-----------|
| Modern C# | `modern-csharp.md` | Records, pattern matching, nullable types |
| ASP.NET Core | `aspnet-core.md` | Minimal APIs, middleware, DI, routing |
| Entity Framework | `entity-framework.md` | EF Core, migrations, query optimization |
| Blazor | `blazor.md` | Components, state management, interop |
| Performance | `performance.md` | Span<T>, async, memory optimization, AOT |
