...
|-------|-----------|-----------|
| App Router | `app-router.md` | File-based routing, layouts, templates, route groups |
| Server Components | `server-components.md` | RSC patterns, streaming, client boundaries |
| Server Actions | `server-actions.md` | Form handling, mutations, revalidation |
| Data Fetching | `data-fetching.md` | fetch, caching, ISR, on-demand revalidation |
| Deployment | `deployment.md` | Vercel, self-hosting, Docker, optimization |
