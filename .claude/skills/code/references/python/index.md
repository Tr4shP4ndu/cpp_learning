...
|-------|-----------|-----------|
| Type System | `type-system.md` | Type hints, mypy, generics, Protocol |
| Async Patterns | `async-patterns.md` | async/await, asyncio, task groups |
| Standard Library | `standard-library.md` | pathlib, dataclasses, functools, itertools |
| Testing | `testing.md` | pytest, fixtures, mocking, parametrize |
| Packaging | `packaging.md` | poetry, pip, pyproject.toml, distribution |
