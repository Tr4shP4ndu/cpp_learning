...
|-------|-----------|-----------|
| Advanced Types | `advanced-types.md` | Generics, conditional types, mapped types, template literals |
| Type Guards | `type-guards.md` | Type narrowing, discriminated unions, assertion functions |
| Utility Types | `utility-types.md` | Partial, Pick, Omit, Record, custom utilities |
| Configuration | `configuration.md` | tsconfig options, strict mode, project references |
| Patterns | `patterns.md` | Builder pattern, factory pattern, type-safe APIs |
