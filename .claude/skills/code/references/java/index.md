...
|-------|-----------|-----------|
| Spring Boot | `spring-boot-setup.md` | Project setup, configuration, starters |
| Reactive | `reactive-webflux.md` | WebFlux, Project Reactor, R2DBC |
| Data Access | `jpa-optimization.md` | JPA, Hibernate, query tuning |
| Security | `spring-security.md` | OAuth2, JWT, method security |
| Testing | `testing-patterns.md` | JUnit 5, TestContainers, Mockito |
