...
|-------|-----------|-----------|
| Pydantic V2 | `pydantic-v2.md` | Creating schemas, validation, model_config |
| SQLAlchemy | `async-sqlalchemy.md` | Async database, models, CRUD operations |
| Endpoints | `endpoints-routing.md` | APIRouter, dependencies, routing |
| Authentication | `authentication.md` | JWT, OAuth2, get_current_user |
| Testing | `testing-async.md` | pytest-asyncio, httpx, fixtures |
| Django Migration | `migration-from-django.md` | Migrating from Django/DRF to FastAPI |
