...
|-------|-----------|-----------|
| Modern C++ Features | `modern-cpp.md` | C++20/23 features, concepts, ranges, coroutines |
| Template Metaprogramming | `templates.md` | Variadic templates, SFINAE, type traits, CRTP |
| Memory & Performance | `memory-performance.md` | Allocators, SIMD, cache optimization, move semantics |
| Concurrency | `concurrency.md` | Atomics, lock-free structures, thread pools, coroutines |
| Build & Tooling | `build-tooling.md` | CMake, sanitizers, static analysis, testing |
