...
|-------|-----------|-----------|
| Modern Syntax | `modern-syntax.md` | ES2023+ features, optional chaining, private fields |
| Async Patterns | `async-patterns.md` | Promises, async/await, error handling, event loop |
| Modules | `modules.md` | ESM vs CJS, dynamic imports, package.json exports |
| Browser APIs | `browser-apis.md` | Fetch, Web Workers, Storage, IntersectionObserver |
| Node Essentials | `node-essentials.md` | fs/promises, streams, EventEmitter, worker threads |
