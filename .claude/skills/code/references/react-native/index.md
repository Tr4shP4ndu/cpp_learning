...
|-------|-----------|-----------|
| Navigation | `expo-router.md` | Expo Router, tabs, stacks, deep linking |
| Platform | `platform-handling.md` | iOS/Android code, SafeArea, keyboard |
| Lists | `list-optimization.md` | FlatList, performance, memo |
| Storage | `storage-hooks.md` | AsyncStorage, MMKV, persistence |
| Structure | `project-structure.md` | Project setup, architecture |
