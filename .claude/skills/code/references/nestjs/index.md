...
|-------|-----------|-----------|
| Controllers | `controllers-routing.md` | Creating controllers, routing, Swagger docs |
| Services | `services-di.md` | Services, dependency injection, providers |
| DTOs | `dtos-validation.md` | Validation, class-validator, DTOs |
| Authentication | `authentication.md` | JWT, Passport, guards, authorization |
| Testing | `testing-patterns.md` | Unit tests, E2E tests, mocking |
| Express Migration | `migration-from-express.md` | Migrating from Express.js to NestJS |
