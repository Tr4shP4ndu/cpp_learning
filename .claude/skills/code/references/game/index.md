...
|-------|-----------|-----------|
| Unity Development | `unity-patterns.md` | Unity C#, MonoBehaviour, Scriptable Objects |
| Unreal Development | `unreal-cpp.md` | Unreal C++, Blueprints, Actor components |
| ECS & Patterns | `ecs-patterns.md` | Entity Component System, game patterns |
| Performance | `performance-optimization.md` | FPS optimization, profiling, memory |
| Networking | `multiplayer-networking.md` | Multiplayer, client-server, lag compensation |
