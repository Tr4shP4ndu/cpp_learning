...
|-------|-----------|-----------|
| Server Components | `server-components.md` | RSC patterns, Next.js App Router |
| React 19 | `react-19-features.md` | use() hook, useActionState, forms |
| State Management | `state-management.md` | Context, Zustand, Redux, TanStack |
| Hooks | `hooks-patterns.md` | Custom hooks, useEffect, useCallback |
| Performance | `performance.md` | memo, lazy, virtualization |
| Testing | `testing-react.md` | Testing Library, mocking |
| Class Migration | `migration-class-to-modern.md` | Converting class components to hooks/RSC |
